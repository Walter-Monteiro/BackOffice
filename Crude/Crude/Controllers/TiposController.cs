...
namespace Crude.Controllers
{
    public class TiposController : Controller
    {
        ...
        public TiposController(CrudeDB context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Tipo,EspacosFK")] Tipos tipos)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Tipo,EspacosFK")] Tipos tipos)
        {
            if (id != tipos.Id)
            {
                return NotFound();
