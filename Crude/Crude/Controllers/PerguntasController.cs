...
namespace Crude.Controllers
{
    public class PerguntasController : Controller
    {
        ...
        public PerguntasController(CrudeDB context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Texto")] Perguntas perguntas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Texto")] Perguntas perguntas)
        {
            if (id != perguntas.Id)
            {
                return NotFound();
